...
public class Students {
    ...
    private final String[] NAMES = {"Владислав", "Ирина", "Вадим", "Максим", "Данил", "Мария", "Станислав", "Надежда", "Анастасия"};
    private final String[] SURNAMES = {"Бондарь", "Батуева", "Убонеев", "Соктоев", "Иконников", "Перевозникова", "Савчук",
            "Балакина"};
    private final String[] MIDDLE_NAMES = {"Андреевич", "Васильевна", "Максимович", "Евгеньевич",};
